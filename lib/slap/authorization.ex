defmodule Slap.Authorization do
  ...
  """
  @spec can_access_room?(%User{}, %Room{}, permission()) :: boolean()
  ...
  """
  @spec can_access_conversation?(%User{}, %Conversation{}, permission()) :: boolean()
  ...
  """
  @spec can_send_room_message?(%User{}, %Room{}) :: boolean()
  ...
  """
  @spec can_send_conversation_message?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec can_manage_room?(%User{}, %Room{}) :: boolean()
  ...
  """
  @spec can_manage_conversation?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec can_delete_any_room_message?(%User{}, %Room{}) :: boolean()
  ...
  """
  @spec can_delete_any_conversation_message?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec can_edit_own_room_message?(%User{}, %Room{}) :: boolean()
  ...
  """
  @spec can_edit_own_conversation_message?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec can_invite_to_conversation?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec can_manage_participants?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec get_room_permissions(%User{}, %Room{}) :: [permission()]
  ...
  """
  @spec get_conversation_permissions(%User{}, %Conversation{}) :: [permission()]
  ...
  """
  @spec is_room_owner?(%User{}, %Room{}) :: boolean()
  ...
  """
  @spec is_conversation_admin?(%User{}, %Conversation{}) :: boolean()
  ...
  """
  @spec is_conversation_moderator?(%User{}, %Conversation{}) :: boolean()
